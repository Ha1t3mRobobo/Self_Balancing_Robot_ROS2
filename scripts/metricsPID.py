...
class ADRCPerformanceLogger(Node):
    ...
    def __init__(self):
        ...
        self.create_subscription(Float64, '/debug/angle', self.angle_callback, 10)
        self.create_subscription(Float64, '/debug/setpoint', self.setpoint_callback, 10)
    ...
    def print_final_report(self):
        print("\n\n" + "\033[92m" + "*"*50)
        print("          RÉSULTATS PID (EN RADIANS)")
        print("*"*50 + "\033[0m")
